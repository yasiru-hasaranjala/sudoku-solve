...
import videoInput.RealTimeSudokuSolver
import videoInput.sudokuSolver
...
def videoView():
    ...
    model.load_weights("videoInput/digitRecognition.h5")   
    ...
    while(True):
        ...
        if ret == True:
            ...
            sudoku_frame = videoInput.RealTimeSudokuSolver.recognize_sudoku_and_solve(frame, model, old_sudoku) 
